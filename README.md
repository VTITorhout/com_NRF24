...
De ESP8266 is een vrij moeilijke IC naar pinnen. Onderstaande lijst is informatie en beschrijft welke pinnen er als in- en als uitgang kunnen gebruikt worden. Eveneens wordt er detail gegegeven of er al dan niet speciale zaken zijn waarmee rekening moet gehouden worden.

In de code moet gebruik gemaakt worden van de GPIO nummers. De Dx nummers zijn louter informatief en bord afhankelijk.
